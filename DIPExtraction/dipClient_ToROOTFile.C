...
void Writer::closeCurrentFile()
{
  if(fCurrentFile!=NULL)
  {
    ...
    f_FileList.open("/afs/cern.ch/user/a/abooth/public/BeamLineDataOutput/Trees_DIPRaw/filesList_BI_ToHist.txt",std::ios_base::app);
    f_FileList << fCurrentFileName << " ";
    f_FileList.close();
    f_FileList.open("/afs/cern.ch/user/a/abooth/public/BeamLineDataOutput/Trees_DIPRaw/filesList_BI_ToTree.txt",std::ios_base::app);
    f_FileList << fCurrentFileName << " ";
    f_FileList.close();
    f_FileList.open("/afs/cern.ch/user/a/abooth/public/BeamLineDataOutput/Trees_DIPRaw/filesList_BL_ToTree.txt",std::ios_base::app);
    f_FileList << fCurrentFileName << " ";
    f_FileList.close();
    f_FileList.open("/afs/cern.ch/user/a/abooth/public/BeamLineDataOutput/Trees_DIPRaw/filesList_BL_ToHist.txt",std::ios_base::app);
    f_FileList << fCurrentFileName << " ";
    f_FileList.close();
    f_FileList.open("/afs/cern.ch/user/a/abooth/public/BeamLineDataOutput/Trees_DIPRaw/filesList_BIBL_ToTree.txt",std::ios_base::app);
    f_FileList << fCurrentFileName << " ";
    f_FileList.close();
    f_FileList.open("/afs/cern.ch/user/a/abooth/public/BeamLineDataOutput/Trees_DIPRaw/filesList_BIBL_ToHist.txt",std::ios_base::app);
    f_FileList << fCurrentFileName << " ";
    f_FileList.close();
    f_FileList.open("/afs/cern.ch/user/a/abooth/public/BeamLineDataOutput/Trees_DIPRaw/filesList_BIBL_ToHistToTree.txt",std::ios_base::app);
    f_FileList << fCurrentFileName << " ";
    f_FileList.close();
  }
  fCurrentFile = NULL;
