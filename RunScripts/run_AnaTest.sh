...
/nfs/sw/BeamLineMonitoring/AnaScripts/AnaTest.exe true /scratch/BeamInstOutput/Trees_DIPRaw/180901-180902_Testing/eventsData_1535871342.root $detectorList
